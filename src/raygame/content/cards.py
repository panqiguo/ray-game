...
CARD_DEFS: dict[str, CardDef] = {
    ...
    "empathy_0_a": CardDef("empathy_0_a", "基础·共情", Suit.EMPATHY, 2, "你试着贴近对方真正的情绪。"),
    ...
    "empathy_1_a": CardDef("empathy_1_a", "热情·共情", Suit.EMPATHY, 3, "你一下就抓住了对方最松动的地方。"),
    ...
    "empathy_2_a": CardDef("empathy_2_a", "灵感·共情", Suit.EMPATHY, 4, "你在沉默里听见了真正的话。"),
    ...
    "paranoid_empathy_1": CardDef("paranoid_empathy_1", "偏执专长·共情", Suit.EMPATHY, 3, "偏执让这张牌变得比平静更锋利。"),
