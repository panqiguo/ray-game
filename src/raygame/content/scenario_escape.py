...
def build_escape_scenario() -> CompiledScenario:
        ...
        actions=(
            limited_use_action(
                ...
                check=check(
                    ...
                    fail=outcome("这一晚没捞到多少，还把自己弄得心烦。", effect("change_resource", "money:10"), effect("change_stress", 1)),
                ),
            ),
            delivery_action(
                id="bar_drink",
        ...
        actions=(
            explore_action(
                ...
                check=check(
                    ...
                    fail=outcome("这里还不认你，你只能先灰头土脸地退开。", effect("change_stress", 2)),
                ),
                thresholds=(
            ...
            action(
                ...
                check=check(
                    ...
                    fail=outcome("你白白耗在雨里，神经也绷得更紧。", effect("change_stress", 2)),
                ),
        ...
        actions=(
            explore_action(
                ...
                check=check(
                    ...
                    fail=outcome("这片地方暂时还不肯给你线索。", effect("change_stress", 1)),
                ),
                thresholds=(
            ...
            action(
                ...
                check=check(
                    ...
                    fail=outcome("他们礼貌地看着你，却什么都没说。", effect("change_stress", 1)),
                ),
        ...
        actions=(
            limited_use_action(
                ...
                check=check(
                    ...
                    fail=outcome("你差点把人和货一起砸了，只能赔笑收场。", effect("change_stress", 2)),
                ),
            ),
        ),
        ...
        actions=(
            single_use_action(
                ...
                check=check(
                    ...
                    fail=outcome("你被赶了出来，身上也留下了更难忽视的伤。", effect("change_health", -1), effect("change_stress", 2)),
                ),
        ...
        actions=(
            single_use_action(
                ...
                check=check(
                    ...
                    fail=outcome("你空手而归，只剩下一肚子窝火。", effect("change_stress", 1)),
                ),
    ...
    world_root, _ = location(
        id="escape_world",
        title="逃离这里",
        description="你还在这座城里，但你已经在找出去的路。",
        actions=(
            rest_action(
                id="catch_breath",
                title="喘口气",
