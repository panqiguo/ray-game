...
(content
 ...
 :root (node
        ...
        :children (list
                   ...
                   (when (and (>= day 2) (< (clock-value residential_info) 4)) residential_area)
                   (when (>= (clock-value residential_info) 2) shop)
                   (when (>= (clock-value residential_info) 3) bulletin_board)
                   (when (>= (clock-value residential_info) 4) repair_shop))))
