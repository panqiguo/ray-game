...
from sincity.game.conditions import (
    action_is_available,
    action_is_visible,
...
from sincity.presentation.card_model import ACTION_CARD, TABLE_CARD, TableCardModel
from sincity.presentation.tags import action_corner_labels, location_status_labels
