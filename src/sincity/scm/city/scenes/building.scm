      ...
      (action
        ...
        :check (check
          ...
          :partial (if (clock-filled? office_attendance)
            ...
            (outcome (list (effect 'set office_processed_day day) (effect 'set office_demoted_notice false) (effect 'clock+ office_attendance 1) (office-performance-effect 1) (effect 'add energy -1))))
          :fail (if (clock-filled? office_attendance)
            ...
            (outcome (list (effect 'set office_processed_day day) (effect 'set office_demoted_notice false) (effect 'clock+ office_attendance 1) (effect 'add energy -1)))))))))