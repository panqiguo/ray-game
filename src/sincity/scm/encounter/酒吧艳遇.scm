...
(content
  ...
  :vars (append
    ...
    (var 'attitude 'cold)
    (var 'ending none)
    (var 'cold_direct_talk_used false)
    (var 'cold_ask_help_used false)
    (var 'cold_use_room_used false)
    (var 'cold_leave_hook_used false)
    (var 'warm_interest_used false)
    (var 'warm_flirt_used false)
    (var 'warm_read_him_used false)
    (var 'warm_keep_distance_used false)
    (var 'soft_follow_lead_used false)
    (var 'soft_make_promise_used false)
